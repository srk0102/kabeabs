...
import { HiOutlinePlus, HiMinusSm, HiEye } from "react-icons/hi";
...
export function Menu() {
  ...
  return (
    <>
            ...
            <li>
              ...
              >
                <div className="relative">
                  ...
                  />
                  {cartItemCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-red-500 rounded-full text-white w-4 h-4 flex items-center justify-center text-xs">
                      {cartItemCount}
                    </span>
                  )}
                </div>
      ...
      <div
        className="flex app__bg md:flex-row md:justify-center gap-3 overflow-x-scroll"
      ...
      >
        {categories?.map((category) => {
          return (
            <>
              <Button
                className="  bg-primary-golden hover:bg-black hover:text-white"
              ...
              <>
                <div className="w-full max-w-sm  border border-gray-200 rounded-lg shadow bg-black dark:border-gray-700">
                  <div className="px-5 pb-5">
                    ...
                    <a href="#">
                      <h5 className="text-xl flex flex-col md:flex-row gap-2 items-center justify-between font-CormorantUpright font-semibold tracking-tight text-slate-100 dark:text-white">
                        {item.title}
                      </h5>
                    ...
                    <div className="flex flex-col md:flex-row gap-2 items-center justify-between">
                      ...
                      <HiEye
                        ...
                        className="text-gray-400 hover:text-gray-200 dark:text-gray-500 dark:hover:text-gray-300 cursor-pointer"
                      />
                      <button
                        onClick={() => addToCart(item)}
