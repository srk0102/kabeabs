              ...
              <div className="p-4 md:p-5 space-y-4">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-primary-golden dark:text-black ">
                      <tr>
                    ...
                    <tbody>
                      {cart.map((item) => {
                        return (
                          <>
                            <tr class="dark:bg-primary-golden border-b dark:border-gray-700">
                              <th
                                scope="row"
                              ...
                              <td class="px-6 py-4 text-black">{item.price}</td>
                              <td class="px-6 py-4">
                      ...
                      <tr class="dark:bg-primary-golden border-b dark:border-gray-700">
                        <th
                          scope="row"
                          class="px-6 py-4 font-medium text-blackwhitespace-nowrap dark:text-white"
                        ></th>
            ...
            <>
              <div className="w-full max-w-sm  border border-gray-200 rounded-lg shadow bg-black dark:border-gray-700">
                <div className="px-5 pb-5">
                  <p
                    className="mb-1 font-CormorantUpright text-center font-semibold text-gray-700 dark:text-gray-400 "
                    style={{ color: "#DCCA87" }}
                  >
                    {item.category}
                  </p>
                  <a href="#">
                    <h5 className="text-xl font-CormorantUpright font-semibold tracking-tight text-gray-900 dark:text-white">
                      {item.title}
                    </h5>
                    <p className="mb-3  font-CormorantUpright font-normal text-gray-700 dark:text-gray-400">
                      {item.description}
                    </p>
                  </a>
